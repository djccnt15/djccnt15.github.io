...
[![PyTorch_logo](/assets/img/posts/logo_PyTorch.png){: width="3%" height="3%"} PyTorch](https://pytorch.org/) 페이스북에서 개발한 라이브러리로 Tensorflow에 비해서 레이어 동작을 더 커스터마이징하기 유용해 학계에서 많이 사용된다고 한다.  
