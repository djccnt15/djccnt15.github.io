...
related_posts:
    - _posts/softwareengineering/2022-08-06-sql_02.md
...
데이터 모델링은 [엔티티(Entity)](/softwareengineering/sql_02/#1-엔티티), [속성(Attribute)](/softwareengineering/sql_02/#2-속성), [관계(Relationship)](/softwareengineering/sql_02/#3-관계)의 3요소로 구성됨  
