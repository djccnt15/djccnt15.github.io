...
related_posts:
    - _posts/softwareengineering/2022-08-18-sql_10.md
...
**트리거(Trigger)**란 특정 테이블에 [DML](/softwareengineering/sql_05/#3-dml)이 수행되었을 때 데이터베이스에서 자동으로 동작하도록 작성된 프로그램으로, 데이터베이스에서 자동적으로 수행한다.  
