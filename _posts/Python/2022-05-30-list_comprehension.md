...
[선형대수](/tags#linear%20algebra)를 공부하면서 `list comprehension`을 많이 사용했는데, 자세한 내용은 [여기](/maths/linear_algebra_02/), [여기](/maths/linear_algebra_03/), [여기](/maths/linear_algebra_08/)를 참고하자.  
