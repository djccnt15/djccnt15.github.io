...
related_posts:
    ...
    - _posts/statistics/2022-12-23-multivariate_date.md
---
...
아래와 같이 SciPy를 사용하면 쉽게 첨도를 쉽게 구할 수 있다. 마찬가지로 빅데이터를 다룰 때 사용할 것으로 생각했는지 자유도를 0으로 계산할 뿐만 아니라 정규분포를 전제하여 -3이 반영된 값을 반환한다.  
