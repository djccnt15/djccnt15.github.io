...
```
```
RelfreqResult(frequency=array([0.58333333, 0.25      , 0.16666667]), lowerlimit=0.5, binsize=1.0, extrapoints=0)
CumfreqResult(cumcount=array([ 7., 10., 12.]), lowerlimit=0.5, binsize=1.0, extrapoints=0)
```
