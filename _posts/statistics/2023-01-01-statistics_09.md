...
여러 개의 확률변수를 순서열 $$X_{1}, X_{2}, \cdots, X_{n}$$로 표시한 것을 **확률벡터(Probability Vector)**라 한다.  
...
따라서 확률벡터 $$X_{1}, X_{2}, \cdots, X_{n}$$이 상호독립이면, 모든 $$x_{1}, x_{2}, \cdots, x_{n}$$에 대해 아래 식이 성립한다.  
...
[표본상관계수](/statistics/statistics_04/#2-2-표본상관계수)와 마찬가지로, 모집단에 대한 확률변수의 상관계수도 [표준화](/statistics/statistics_03/#표준화)한 확률변수를 통해 계산한다.  
