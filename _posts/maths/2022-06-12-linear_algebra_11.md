...
**직교 행렬(orthogonal matrix)**이란 어떤 행렬의 행 벡터와 열 벡터가 [**정규 직교(orthonomal) 기저**](/maths/2022-06-05-linear_algebra_07/#3-직교-공간)를 이루는 행렬을 의미한다. 직교 행렬은 자신의 [전치 행렬](/maths/2022-05-19-linear_algebra_02/#1-전치-행렬)과 곱했을 때 [단위 행렬](/maths/2022-05-19-linear_algebra_02/#4-단위-행렬)이 있어 이를 통해 주어진 행렬이 직교 행렬인지 확인할 수 있다.  
