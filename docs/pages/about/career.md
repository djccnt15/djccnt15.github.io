...
- 온디바이스 AI 판정 시스템 서비스 개발
    - 기존 온프레미스 배치 방식 판정 시스템을 온디바이스 시스템으로 개선 전환
    - 비효율적 구조로 인한 시스템 오류 및 장애 상황 해결
    - 레거시 시스템 분석 및 서비스 아키텍처 설계
    - REST API 서버 앱 및 데이터 실시간 아카이빙 배치 앱 개발
    - 운영 관리 및 유지보수 편의성 재고
